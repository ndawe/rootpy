...
#
# rootpy shared Sphinx settings.  These settings are shared between
# rootpy itself and affiliated packages.
#
...
intersphinx_mapping = {
    ...
    'rootpy': ('http://www.rootpy.org/', None),
    }
...
extensions = [
    ...
    'rootpy.sphinx.ext.numpydoc',
    'rootpy.sphinx.ext.rootpyautosummary',
    'rootpy.sphinx.ext.automodsumm',
    'rootpy.sphinx.ext.automodapi'
    ]
...
# pixels large.
html_favicon = 'rootpy_logo.ico'  # included in the bootstrap-rootpy theme
